...
```swift
.package(url: "https://github.com/aspose-barcode-cloud/Aspose.BarCode-Cloud-SDK-for-Swift.git", from: "26.8.0")
```

Releases use the BarCode SDK tag style, for example `v26.8.0`. SwiftPM version requirements still use the semantic version value without the `v` prefix.
