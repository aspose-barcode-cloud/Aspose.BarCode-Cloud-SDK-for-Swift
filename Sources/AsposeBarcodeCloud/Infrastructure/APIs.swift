...
open class AsposeBarcodeCloudAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.aspose.cloud/v4.0",
    ...
    public static let shared = AsposeBarcodeCloudAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public required init(
        ...
        apiConfiguration: AsposeBarcodeCloudAPIConfiguration = AsposeBarcodeCloudAPIConfiguration.shared
    ) {
        self.method = method
